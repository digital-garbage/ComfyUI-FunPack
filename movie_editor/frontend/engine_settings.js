...
(function () {
  ...
  const SAMPLER_KNOBS = [
    ...
    { name: "h3_prompt_time", label: "Reference weight", kind: "float", default: 0.0, min: 0.0, max: 1.0, step: 0.01,
      hint: "How much the reference you gave it drives the final video. It now only applies over the second half of the schedule, so the shot is composed first and pulled toward the reference after. 0.0 = off. Try 1.0 \u2014 earlier builds applied it throughout and anything above about 0.5 simply reproduced the reference. Free.",
      detail: "The model marks each part of its sequence as finished or still forming, and \u0027finished\u0027 is how it recognises reference material \u2014 something given, to be reproduced. This dial sets that mark on your prompt. Turned up, the prompt joins the given material and the reference image takes over the frame; turned down, the prompt reads as a rough draft and the model fills in around it. It was built expecting to improve prompt adherence and does not: what it actually moves was found by testing. Not learned from ratings, because its off value sits at the end of its range rather than the middle." },
