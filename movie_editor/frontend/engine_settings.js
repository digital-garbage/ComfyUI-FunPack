...
(function () {
  ...
  const SAMPLER_KNOBS = [
    ...
    { name: "h3_prompt_time", label: "Reference weight", kind: "float", default: 0.0, min: 0.0, max: 1.0, step: 0.01,
      hint: "How literally the model takes the reference you gave it. 1.0 reproduces it almost exactly. Around 0.4 it follows the prompt but invents things that were in neither. Below 0.3 the picture starts breaking up. 0.0 = off. Measured on a rental, not predicted \u2014 start at 0.7. Free.",
