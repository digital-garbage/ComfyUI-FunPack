...
(function () {
  ...
  const SAMPLER_KNOBS = [
    ...
    { name: "block_steer",           label: "Block steering",        kind: "bool",  default: false },
    { name: "block_steer_strength",  label: "Block steer strength",  kind: "float", default: 0.05, min: 0.01, max: 0.15, step: 0.005, dependsOn: "block_steer" },
  ...
  const CHAIN_SECTIONS = [
    ...
    { id: "chain_guid", title: "Guidance", defaultOpen: false, knobs: ["cfg", "embed_guidance", "embed_guidance_source", "embed_guidance_strength", "score_slider", "score_slider_strength", "output_guidance", "output_guidance_strength", "block_steer", "block_steer_strength"] },
