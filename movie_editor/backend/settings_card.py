...
_OWNED_EXTRA = {
    ...
    "prompt_enhance_use_image": ("prompt_enhance", ('true',)),
    "prompt_enhance_top_k": ("prompt_enhance", ('true',)),
    "prompt_enhance_min_p": ("prompt_enhance", ('true',)),
    "prompt_enhance_repetition_penalty": ("prompt_enhance", ('true',)),
...
_OWNED_BY = {
    **_OWNED_EXTRA,
    ...
    "h3_block_repeat_span_loop": ("h3_block_repeat", None),
    "h3_block_repeat_video_only": ("h3_block_repeat", None),
    "h3_block_repeat_last_steps": ("h3_block_repeat", None),
    "h3_repr_steering_block": ("h3_repr_steering", None),
    "h3_repr_steering_strength": ("h3_repr_steering", None),
    "h3_q_steer_strength": ("h3_q_steer_block", None),
    "h3_explore_temperature_block": ("h3_explore_temperature", None),
    "explore_first_step_candidates": ("explore_first_step", None),
    "h3_shadow_negative_video_scale": ("h3_shadow_negative", None),
    "h3_shadow_negative_audio_scale": ("h3_shadow_negative", None),
    "h3_shadow_negative_tau": ("h3_shadow_negative", None),
    "h3_shadow_negative_alpha": ("h3_shadow_negative", None),
    "h3_shadow_negative_start_percent": ("h3_shadow_negative", None),
    "h3_shadow_negative_end_percent": ("h3_shadow_negative", None),
    "h3_shadow_negative_compose": ("h3_shadow_negative", None),
...
_EDITOR_DEFAULTS = {
    ...
    "explore_first_step": False,
    "explore_first_step_candidates": 3,
    "frame_overlap": 16,
    "h3_av_decouple": 0.0,
    "h3_explore_temperature": 0.0,
    "h3_explore_temperature_block": "40-49",
    "h3_shadow_negative": False,
    "h3_shadow_negative_video_scale": 3.0,
    "h3_shadow_negative_audio_scale": 1.0,
    "h3_shadow_negative_tau": 2.5,
    "h3_shadow_negative_alpha": 0.35,
    "h3_shadow_negative_start_percent": 0.0,
    "h3_shadow_negative_end_percent": 0.6,
    "h3_shadow_negative_compose": False,
    "h3_block_repeat": "",
    ...
    "prompt_enhance_use_image": True,
    "prompt_enhance_top_k": 50,
    "prompt_enhance_min_p": 0.05,
    "prompt_enhance_repetition_penalty": 1.3,
