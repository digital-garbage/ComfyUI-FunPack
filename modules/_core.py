...
try:                                             # root on sys.path: tests, dev server
    from core import chain, contract, log, media, patching, registry, relations, run, schema, traits
except ImportError:                              # inside ComfyUI: a subpackage of the pack
    from ..core import chain, contract, log, media, patching, registry, relations, run, schema, traits

__all__ = ["chain", "contract", "log", "media", "patching", "registry", "relations", "run", "schema", "traits"]
