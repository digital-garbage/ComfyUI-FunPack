...
(function () {
  ...
  const SAMPLER_KNOBS = [
    ...
    { name: "h3_explore_temperature", label: "Randomizer (H3, experimental)", kind: "float", default: 0.0, min: 0.0, max: 3.0, step: 0.1,
      hint: "Flattens attention at the block(s) below so the model is less sure how to weigh what it's already conditioned on — variety that stays bounded by the prompt, unlike latent noise. 0 = off. Manual dial, NOT rating-driven or coupled to REINS." },
